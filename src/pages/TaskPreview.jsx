...
const TaskPreview = () => {
  ...
  const imageUrl =
    "https://cdn.hashnode.com/res/hashnode/image/upload/v1700173797804/48f89484-bffe-4d65-b044-f727cc2d3c9e.png";
  ...
  return (
    <section
      className="container mt-10 mx-auto bg-slate-700 rounded-lg w-[80%] px-3
     sm:w-[30%]"
    >
      <header
        className="px-5 py-4 mx-auto flex justify-center 
    items-center gap-3"
      >
        <img
          className=" mt-2 w-[40px] h-[40px] rounded-lg"
          src={imageUrl}
          alt="Taskify Logo"
        />

        <h1
          className="text-3xl text-center text-slate-200 mt-5 
  font-medium"
        >
          Taskify
        </h1>
        ...
        <section id="preview-container">
          <section className=" group flex justify-between items-center gap-2">
            <div className=" flex items-center gap-2 mb-2">
              ...
              />
              <h3 className="text-xl text-slate-100">{task.title}</h3>
            </div>

            <div className="items-center gap-3 hidden group-hover:block">
              <button onClick={togglePreviewForm}>
                <svg
      ...
      <section className="mt-5">
        <Link to="/">
          <button
            className="flex items-center gap-1 text-slate-300 hover:text-amber-600
